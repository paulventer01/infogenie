...
export const INTEGRATION_CATALOG: IntegrationEntry[] = [
  ...
  { key: "hacker_news", name: "Hacker News (Algolia API)", purpose: "Tech-community signals and discussion mining — free, no key", status: "live", authKind: "none" },
  { key: "wikipedia", name: "Wikipedia (REST API)", purpose: "Company and industry background evidence — free, no key", status: "live", authKind: "none" },
  { key: "frankfurter", name: "Frankfurter FX (ECB rates)", purpose: "Daily currency conversion rates for budget views — free, no key", status: "live", authKind: "none" },
  { key: "web_fetch", name: "Direct site fetch", purpose: "First-party fetch of a subject website (title, description) — free, no key", status: "live", authKind: "none" },
