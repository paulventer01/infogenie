...
| CR-049 | POST | `/api/backlink-opportunities` | gen | covered | bounded decoded JSON before return; demo markers retained | complete; UI/outreach/copy warnings | — | backlink-opportunity-safety + governance browser |
