...
function buildCompanyOverview(domain, industryName, analysisData) {
  ...
  // SE Ranking project-menu journey for the analysed company
  const journey = [
    ...
    { step: 7, label: 'Marketing Plan', desc: '90-day battle plan', view: 'battleplan', done: comps.length > 0 },
...
module.exports = { buildCompanyOverview, buildOverviewWidgets };
