...
const ROUTE_GROUPS = [
  ...
  { prefix: '/api/daily-trends',              view: 'seo.view', write: 'seo.run' },
  { prefix: '/api/traffic-sources',           view: 'seo.view', write: 'seo.run' },
  { prefix: '/api/market-overview',           view: 'compete.competitors.view', write: 'compete.competitors.manage' },
  { prefix: '/api/serp-gap',                  view: 'seo.view', write: 'seo.run' },
  { prefix: '/api/llm-gap',                   view: 'seo.view', write: 'seo.run' },
  { prefix: '/api/ad-intel',                  view: 'compete.ad_spy.view', write: 'compete.ad_spy.manage' },
  { prefix: '/api/influencer-analytics',      view: 'reach.leads.view', write: 'reach.leads.manage' },
  { prefix: '/api/brand-monitor',             view: 'compete.intel.view', write: 'compete.intel.manage' },
  ...
  { prefix: '/api/document-rag',              view: 'manage.ask.use',       write: 'manage.ask.use' },
  { prefix: '/api/enterprise-search',         view: 'manage.ask.use',       write: 'manage.ask.use' },
  { prefix: '/api/automation-bridge',         view: 'reach.journeys.view',  write: 'reach.journeys.view' },
  ...
  { prefix: '/api/marketing-plan',            view: 'dashboard.view',       write: 'dashboard.view' },
...
const COMPONENT_MATRIX = {
  ...
  'influencer-analytics': 'reach.leads.view',
  'brand-monitor':        'compete.intel.view',
  'geo-audit':            'seo.view',
