...
function _openai(messages, opts = {}) {
  ...
  const body = JSON.stringify({ model: opts.model || 'gpt-4o-mini', messages, response_format: opts.json ? { type:'json_object' } : undefined, temperature: opts.temperature ?? 0.4, max_tokens: opts.max_tokens || 2000 });
