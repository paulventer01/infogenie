...
const graphFields=['campaign_draft_id','campaign_draft_revision','publishing_request_id','publish_approval_id','delivery_intent_id','credential_reference_id','credential_reference_version'];
