    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { view: "job-board-spy", icon: "💼", label: "Hiring Spy" },
          { view: "change-monitor", icon: "🔔", label: "Change Monitor" },
          { view: "spyfu", icon: "🕵️", label: "SpyFu — PPC & SEO Spy" },
        ],
      },
      {
        header: "4 · Market & share of voice",
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          { view: "geo-audit", icon: "🛸", label: "GEO / AI Visibility" },
          ...
          { view: "ahrefs", icon: "🔍", label: "Ahrefs Intel" },
        ],
      },
    ],
    footer: {
