...
test('orchestrator: the workflows route group is prefix-anchored', () => {
  ...
  assert.equal(
    matrix.requiredPermissionForRequest('/api/agent-orchestrator/proposals', 'GET').permission,
    'orchestrator.workflows.view'
  );
  assert.equal(
    matrix.requiredPermissionForRequest('/api/agent-orchestrator/proposals', 'POST').permission,
    'orchestrator.workflows.view'
  );
  assert.equal(
    matrix.requiredPermissionForRequest('/api/agent-orchestrator/static-images', 'GET').permission,
    'orchestrator.workflows.view'
  );
  assert.equal(
    matrix.requiredPermissionForRequest('/api/agent-orchestrator/static-images', 'POST').permission,
    'orchestrator.workflows.view'
  );
  assert.equal(
    matrix.requiredPermissionForRequest('/api/agent-orchestrator/video-jobs', 'GET').permission,
    'orchestrator.workflows.view'
  );
  assert.equal(
