/* ============================================================================
 * ig_mentions_gaps.js — Real-time Alerts · Webhook channels ·
 *   Company Intel · Ad-Platform Connections · AI Optimizer dashboard
 *   (incl. creative-refresh / bandit / fatigue panels).
 *
 * NOTE: Mention Tracker, Content Gaps, Cross-Channel Report, Stakeholders,
 * and Launch Calendar view-builders were removed (July 2026) — their #view-*
 * divs were stripped and navigateTo dispatch blocks deleted when those screens
 * were migrated to React. Only the shared helpers that are reachable from live
 * code remain here.
 *
 * Plain global script, loaded after app.js in index.html. Wrapped in one IIFE;
 * public entry points and onclick targets re-exported to window at the bottom.
 *
 ...
 *   currentCampaign, and the window._alertsState global this module owns.
 * ========================================================================== */
