...
export const MARKETING_HUBS: Record<string, MarketingHubDef> = {
  ...
  "seo-ai-visibility": {
    ...
    tiles: [
      ...
      { view: "seo-growth-autopilot", icon: "🚀", label: "SEO Growth Autopilot", desc: "Growth-plan SEO execution" },
      { view: "autoseo", icon: "✈️", label: "AutoSEO Pro", desc: "Autonomous SEO operator", tag: "Coming soon" },
      { view: "gsc-data", icon: "🧾", label: "Search Console Data", desc: "GSC queries, pages, clicks" },
    ],
  },
  "creative-hub": {
    id: "creative-hub",
    group: "Create",
    title: "🖌️ Creative Studio",
    subtitle: "Single-ad creatives, multi-variant builders, and ad creative generation — pick the right tool for the job.",
    tiles: [
      { view: "creative", icon: "🖌️", label: "AI Creative", desc: "Generate a single ad creative", tag: "Start here" },
      { view: "smart-creative", icon: "✨", label: "Smart Creative Builder", desc: "Multi-variant creative sets" },
      { view: "ad-creative", icon: "🖍️", label: "Ad Creative Gen", desc: "Campaign-ready ad packages" },
      { view: "creative-intel", icon: "💡", label: "Creative Intel", desc: "What creatives perform" },
      { view: "carousel", icon: "🎠", label: "Carousel Generator", desc: "Multi-card social ads" },
    ],
  },
  "pages-hub": {
    id: "pages-hub",
    group: "Create",
    title: "🚀 Pages & Sites",
    subtitle: "AI landing pages, drag-and-drop builders, and multi-page site kits — one entry for every page workflow.",
    tiles: [
      { view: "landing-pages", icon: "🚀", label: "AI Landing Pages", desc: "A/B pages · leads · ad package", tag: "Start here" },
      { view: "landing-builder", icon: "🌎", label: "Landing Page Builder", desc: "Visual landing-page editor" },
      { view: "site-builder", icon: "🏗️", label: "Site Builder", desc: "Multi-page marketing sites" },
      { view: "linksell", icon: "🛒", label: "Link-in-Bio", desc: "Bio page + Stripe checkout" },
      { view: "wireframe", icon: "📏", label: "Wireframe Generator", desc: "Structure before design" },
    ],
  },
  "organic-performance": {
    ...
    subtitle: "Monitor competitors, listen to mentions, and read your own organic analytics — without four separate menus.",
    tiles: [
      { view: "organic-social", icon: "📱", label: "Organic Social Monitor", desc: "Competitor organic activity", tag: "Monitor" },
      { view: "social-listening", icon: "👂", label: "Social Listening", desc: "Brand mentions & sentiment" },
      { view: "social-analytics", icon: "🖇️", label: "Organic Social Analytics", desc: "Engagement & growth" },
      { view: "post-performance", icon: "⚗️", label: "Post Performance", desc: "Top posts & patterns" },
      { view: "social-command-center", icon: "📤", label: "Social Command Center", desc: "Publish · approve · inbox" },
      { view: "hashtag-intel", icon: "🔖", label: "Hashtag Intelligence", desc: "Instagram & TikTok tags" },
    ],
  },
};
